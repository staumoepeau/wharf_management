...
#    user_roles = frappe.get_roles()
    if "System Manager" in frappe.get_roles() or "Wharf Operation Cashier" in frappe.get_roles() or "Wharf Security Manager" in frappe.get_roles() or "Pilot Operation Manager" in frappe.get_roles() or "Yard Inspection User" in frappe.get_roles():
        return None
    else:
