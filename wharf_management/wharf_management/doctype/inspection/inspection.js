...
frappe.ui.form.on('Inspection', {
    ...
    onload: function(frm) {
        ...
        frm.toggle_enable(['container_content', 'secondary_work_type', 'mark', 'cargo_type', 'final_work_type', 'cargo_ref', 'work_information',
            'vessel', 'vessel_arrival_date', 'bol', 'container_no', 'chasis_no', 'third_work_type', 'last_port', 'voyage_no', 'work_type', 'booking_ref'
        ], is_allowed);

        frm.toggle_display(['booking_ref', 'cargo_ref'], frappe.user_roles.includes('System Manager', 'Cargo Operation Manager', 'Operation Manifest User'));
    }
});