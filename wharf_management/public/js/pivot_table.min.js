...
frappe.views.QueryReport = frappe.views.QueryReport.extend({
    ...
    make_toolbar: function make_toolbar() {
        this._super();
        this.print_icon = this.page.add_action_icon("fa fa-cube", function () {
            me.frm.print_doc();
        });
    },
